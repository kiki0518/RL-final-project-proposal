...
\begin{itemize}
    \item \textbf{ADPO} \citep{huang2025image}: An adversarial direct preference optimization framework that formulates image difference captioning (IDC) as a preference learning problem. It improves fine-grained difference alignment by coupling the captioning model with an adversarially trained hard-negative retriever to generate challenging counterfactual samples.
\end{itemize}
