...
- **Data**:
  - Images derived from the VIRAT Video Dataset are governed by the
    original VIRAT Video Dataset Usage Agreement (see DATA_LICENSE.txt).
  - Text annotations created by the authors are released under the
